$(document).ready(function(){
    ...
    $("#btnEditar").click(function(){
        ...
        $.ajax({
            url:"http://localhost/carrito_compras/carrito_editarProd.php",
            method:"POST",
            dataType:"json",
    ...
    $("#btnRemover").click(function(){
        var codigo = $("#codigoFk").text();
        $.ajax({
            url:"http://localhost/carrito_compras/carrito_removerProd.php",
            method:"POST",
            dataType:"json",
...
function mostrarTablaProductos(){
    $.ajax({
        ...
        $.each(data, function(index, value){
            ...
            adjuntarHtml += "<td><img class='foto-producto' src='http://localhost/carrito_compras/" + value.imagenchica + "'></td>",
            ...
            $(pointer).click(function(){
                ...
                var strUrl = urlImagen.substr(33); //Sustrae el url a partir del caracter 32
...
function mostrarTablaCarrito(){
    $.ajax({
        ...
        $.each(data, function(index, value){
            ...
            otroHtml += "<td><img class='foto-producto' src='http://localhost/carrito_compras/" + value.imagen + "'></td><td>" + value.nombre + "</td> <td>" + value.precio + "</td> <td>" + value.cantidad + "</td>",
